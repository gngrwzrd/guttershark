package 
{
	...
	public class Main extends DocumentController 
	{
		...
		override protected function onPreloadComplete(e:Event):void
		{
			...
			track.register(button1,MouseEvent.CLICK,"trackTest1",{dynamicData:getTrackData});
		...
		{
			track.track("trackTest1", {dynamicData:getTrackData});
			track.track("trackTest2", { dynamicData:getTrackData });
		}
		
		private function getTrackData():Object
		{
			return  { 
				testPrintfValues:["Hello World",100,null],
				urlPrintfValues:["sexy/"] 
			};
		}
	}
}